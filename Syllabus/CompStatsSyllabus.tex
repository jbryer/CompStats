...
\vskip.25in
\noindent \textbf{Course Objectives}: At the completion of the seminar students should be able to analyze large datasets using reproducible techniques. This includes utilizing analytic approaches not available in commercial statistical software.
